...
#vs-memorial-banner { display: none; position: relative; z-index: 199; background: linear-gradient(100deg, #050B18 0%, #0F3E9E 55%, #4D90F0 100%); box-shadow: 0 2px 14px rgba(0,0,0,0.4); overflow: visible; }
