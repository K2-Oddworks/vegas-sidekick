...
#vs-memorial-banner .vsm-ufo-body { font-size: 1.6rem; line-height: 1; text-align: center; filter: drop-shadow(0 2px 3px rgba(0,0,0,0.4)); animation: vsmUfoWobble 3s ease-in-out infinite; }
#vs-memorial-banner .vsm-ufo-beam { position: absolute; left: 50%; top: 76%; width: 12px; height: 20px; transform: translateX(-50%); background: linear-gradient(to bottom, rgba(255,246,160,0.6), rgba(255,246,160,0)); clip-path: polygon(32% 0, 68% 0, 100% 100%, 0% 100%); animation: vsmBeamPulse 2.6s ease-in-out infinite; pointer-events: none; }
...
#vs-memorial-banner .vsm-ufo-light-1 { left: 2px; background: #FF6B2B; animation-delay: 0s; }
#vs-memorial-banner .vsm-ufo-light-2 { left: 16px; background: #4ade80; animation-delay: 0.5s; }
#vs-memorial-banner .vsm-ufo-light-3 { right: 2px; background: #1A6BFF; animation-delay: 1s; }
